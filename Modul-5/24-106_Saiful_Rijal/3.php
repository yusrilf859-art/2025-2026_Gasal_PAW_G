...
<h2 style="font-family:'Courier New', Courier, monospace; font-weight:bold; font-size:30px; color:blue; margin-top:20px;">Edit Data Master Supplier</h2>
...
<form method="POST" action="">
    <table cellpadding="10">
        ...
        <tr>
            <td></td>
            <td>
                <button type="submit" style="background-color:green; color:white; border:none; border-radius:5px; padding:8px 15px; cursor:pointer;">Update</button>
