...
if(isset($_POST["submit"])){
    ...
    $isNama = validateName($errors, $nama);
    $isTelp = validatePhone($errors, $telp);
    $isAlamat = validateAddress($errors, $alamat);
...
<body>
    ...
    <form action="" method="post">
        ...
        <div>
            <button class="btn submit" type="submit" name="submit" onclick="return confirm('Yakin ingin menambahkan data?')">Simpan</button>
